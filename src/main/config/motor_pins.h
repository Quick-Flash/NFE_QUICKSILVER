...
#ifdef F0
#define MOTOR_PIN_PA0 MOTOR_PIN(A, 0, GPIO_AF_2, TIM2, 1)
#define MOTOR_PIN_PA1 MOTOR_PIN(A, 1, GPIO_AF_2, TIM2, 2)
#define MOTOR_PIN_PA2 MOTOR_PIN(A, 2, GPIO_AF_2, TIM2, 3)
#define MOTOR_PIN_PA3 MOTOR_PIN(A, 3, GPIO_AF_2, TIM2, 4)
#define MOTOR_PIN_PA4 MOTOR_PIN(A, 4, GPIO_AF_4, TIM14, 1)
#define MOTOR_PIN_PA5 MOTOR_PIN(A, 5, GPIO_AF_2, TIM2, 1)
#define MOTOR_PIN_PA6 MOTOR_PIN(A, 6, GPIO_AF_1, TIM3, 1)
#define MOTOR_PIN_PA7 MOTOR_PIN(A, 7, GPIO_AF_1, TIM3, 2)
#define MOTOR_PIN_PA8 MOTOR_PIN(A, 8, GPIO_AF_2, TIM1, 1)
#define MOTOR_PIN_PA9 MOTOR_PIN(A, 9, GPIO_AF_2, TIM1, 2)
#define MOTOR_PIN_PA10 MOTOR_PIN(A, 10, GPIO_AF_2, TIM1, 3)
#define MOTOR_PIN_PA11 MOTOR_PIN(A, 11, GPIO_AF_2, TIM1, 4)

#define MOTOR_PIN_PB0 MOTOR_PIN(B, 0, GPIO_AF_1, TIM3, 3)
